/*
this script reads for button press or digital nidaq signal 
may remove serial communication if not used. 
ask anthony if NIDAQ pin should be set to pulldown?? similar for button? 

to open the solenoid. currently, the code works (LEDs turn on as expected)
but the power supply 9V may be insufficient to open the solenoid 12V, or these are bad solenoids! 
need to check power and solenoid. 
*/
...
int sol_duration = 300; //msec. dur for solenoid valve to open
bool sol_open = false;
